import { Divider, Paper, Typography, Grid, Avatar, TextField, Box, TextareaAutosize } from '@mui/material'
    ...
    return (
        <>
            <Paper sx={{ width: '100%', "& input[type='file']": { display: 'none' } }}>
                ...
                <Grid className={classes.flexRow} sx={{ padding: '0 16px', justifyContent: 'space-between' }}>
                    <Avatar />
                ...
                {addPostData.file && showMore && <img src={addPostData.file} alt="add img" className={classes.uploadImg} />}
                <FileBase64
                    className="HELLO"
                    type="file"
                    multiple={false}
